...
class Input
{
    ...
    public:
        ...
        enum KEYS
        {
            ...
            KEY_SPACE, KEY_BACKSPACE, KEY_ESCAPE, KEY_TILDE, KEY_MINUS, KEY_EQUALS, KEY_TAB, KEY_ENTER, KEY_QUOTE, KEY_COMMA, KEY_PERIOD, KEY_OPENBRACE, KEY_CLOSEBRACE, KEY_SLASH, KEY_BACKSLASH, KEY_LCTRL, KEY_RCTRL, KEY_ALT //Once off stuff.
        };
